 ...
 */
public class TourismActivity extends Catalog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setCatalogType("pariwisata");
        String url =getString(R.string.base_url) + "products/catalog?api_token="+customer.getApi_token()+
                "&catalog="+getCatalogType()+"&offset=0";
        loadProduct(TourismActivity.this, url, adapter, _listView, _fab);
        handleIntent(getIntent(), TourismActivity.this, searchView, _listView);
    }

    @Override
    protected void onNewIntent(Intent intent) {
        setIntent(intent);
        handleIntent(intent, TourismActivity.this, searchView, _listView);
    }
