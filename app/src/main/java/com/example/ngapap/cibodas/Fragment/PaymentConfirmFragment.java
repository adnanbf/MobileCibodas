...
public class PaymentConfirmFragment extends Fragment {
    ...
    public String SERVER ="http://192.168.137.1/C-Bodas/public/api/v1/reservation/paymentConfirmation", timestamp;
        ...
        uploadImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(imageView.getDrawable()!=null){
                    ...
                    new Upload(image,"IMG_"+timestamp+reservation.getId_reservation()).execute();
                }else{
