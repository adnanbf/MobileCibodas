 ...
 */
public class AgriActivity extends Catalog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setCatalogType("pertanian");
        String url = getString(R.string.base_url) + "products/catalog?api_token=" + customer.getApi_token() +
                "&catalog=" + getCatalogType() + "&offset=0";
        loadProduct(AgriActivity.this, url, adapter, _listView, _fab);
        handleIntent(getIntent(), AgriActivity.this, searchView, _listView);
        _frame.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
    ...
    protected void onNewIntent(Intent intent) {
        setIntent(intent);
        handleIntent(intent, AgriActivity.this, searchView, _listView);
    }
